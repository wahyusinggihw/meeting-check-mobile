...
class RouteGenerator {
  static Route<dynamic> generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      // untuk menangani jika user sudah pernah absen dari (home screen)
      case '/success':
        return MaterialPageRoute(
            builder: (_) => const SuccessScreen(), settings: settings);
      // untuk menangani setelah mengisi form absensi  (dari qr dan home)
      case '/qr-success':
        return MaterialPageRoute(
            builder: (_) => const QrSuccessScreen(), settings: settings);
      // untuk handle qr code tidak valid
      case '/qr-failed':
        return MaterialPageRoute(
    ...
    // case '/search':
    //   return MaterialPageRoute(
    //       builder: (context) => const KindaCodeDemo(), settings: settings);
